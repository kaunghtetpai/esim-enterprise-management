...
exports.sanitizeInput = exports.validateDateRange = exports.validatePagination = exports.validateUUID = exports.validateUser = exports.validateDevice = exports.validateProfile = exports.validateRequest = void 0;
...
const validateUser = (req, res, next) => {
    ...
    // Required field validation
    if (!azure_user_id)
        errors.push('Azure User ID is required');
    if (!email)
