...
exports.completeSystemService = exports.CompleteSystemService = void 0;
...
class CompleteSystemService {
    ...
    async checkAllSystems() {
        ...
        try {
            ...
            if (!status.apis)
                status.errors.push('API validation failed');
            // Check Sync
            const syncCheck = await this.checkSync();
            status.sync = syncCheck.synced;
            if (!status.sync)
                status.errors.push('Sync issues detected');
            return status;
        }
        catch (error) {
    ...
    async checkSync() {
        ...
        try {
            ...
            if (!projects.find((p) => p.name === 'esim-enterprise-management')) {
...
exports.CompleteSystemService = CompleteSystemService;
exports.completeSystemService = new CompleteSystemService();
//# sourceMappingURL=completeSystemService.js.map