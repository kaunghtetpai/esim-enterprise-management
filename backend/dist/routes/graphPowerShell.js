...
const graphPowerShellService_1 = require("../services/graphPowerShellService");
const auth_1 = require("../middleware/auth");
const errorHandler_1 = require("../middleware/errorHandler");
const router = express_1.default.Router();
const graphService = new graphPowerShellService_1.GraphPowerShellService();
router.post('/connect', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin']), (0, errorHandler_1.asyncHandler)(async (req, res) => {
    try {
        ...
        const connected = await graphService.connectToGraph(tenantId, clientId, interactive ? undefined : clientSecret);
        if (!connected) {
...
router.get('/devices', auth_1.authenticateToken, (0, errorHandler_1.asyncHandler)(async (req, res) => {
    try {
        ...
        if (filter) {
            ...
            filteredDevices = devices.filter(device => device.deviceName?.toLowerCase().includes(filterLower) ||
...
router.post('/profiles', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin', 'it_staff']), (0, errorHandler_1.asyncHandler)(async (req, res) => {
    try {
        ...
        const profileId = await graphService.createeSIMProfile(profileName, iccid, carrier, activationCode);
        res.status(201).json({
            success: true,
            data: {
                profileId,
...
router.post('/install-sdk', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin']), (0, errorHandler_1.asyncHandler)(async (req, res) => {
    try {
...
router.post('/disconnect', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin']), (0, errorHandler_1.asyncHandler)(async (req, res) => {
    try {
...
//# sourceMappingURL=graphPowerShell.js.map