...
export class ESIMController {
  constructor(
    private esimService: ESIMProfileService,
    private intuneService: IntuneService,
  ...
  async getProfiles(req: Request, res: Response): Promise<void> {
    try {
      ...
      const profiles = await this.esimService.getProfiles(
        organizationId,
  ...
  // Device Assignment
  async assignProfileToDevice(req: Request, res: Response): Promise<void> {
    try {
      const { organizationId, userId } = req.user;
  ...
  async removeProfileFromDevice(req: Request, res: Response): Promise<void> {
    try {
      const { organizationId, userId } = req.user;
      ...
      const commandId = await this.intuneService.removeESIMProfile(
        assignment.deviceId,
        profile.iccid
      );
  ...
  // Migration
  async migrateProfile(req: Request, res: Response): Promise<void> {
    try {
      const { organizationId, userId } = req.user;
  ...
  // Bulk Operations
  async bulkActivation(req: Request, res: Response): Promise<void> {
    try {
      const { organizationId, userId } = req.user;
  ...
  async getActivationStatus(req: Request, res: Response): Promise<void> {
    try {
