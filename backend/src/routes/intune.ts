...
router.get('/devices', authenticateToken, validatePagination, asyncHandler(async (req: any, res) => {
  try {
    const intuneService = new IntuneService(req.authProvider);
...
router.get('/devices/:deviceId/configuration', authenticateToken, validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
...
// Get eUICC devices
router.get('/devices/:deviceId/euicc', authenticateToken, validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
    const { deviceId } = req.params;
    const intuneService = new IntuneService(req.authProvider);
...
router.post('/devices/:deviceId/esim/configure', authenticateToken, requireRole(['admin', 'it_staff']), validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
    const { deviceId } = req.params;
...
router.post('/devices/:deviceId/esim/:eUICCId/reset', authenticateToken, requireRole(['admin']), validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
...
router.get('/devices/:deviceId/esim/:ICCID/status', authenticateToken, validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
...
// Enable eSIM profile
router.post('/devices/:deviceId/esim/:ICCID/enable', authenticateToken, requireRole(['admin', 'it_staff']), validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
    const { deviceId, ICCID } = req.params;
...
router.post('/devices/:deviceId/esim/:ICCID/disable', authenticateToken, requireRole(['admin', 'it_staff']), validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
    const { deviceId, ICCID } = req.params;
...
router.get('/devices/:deviceId/compliance', authenticateToken, validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
    const { deviceId } = req.params;
    const intuneService = new IntuneService(req.authProvider);
...
router.post('/devices/:deviceId/sync', authenticateToken, requireRole(['admin', 'it_staff']), validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
    const { deviceId } = req.params;
    const intuneService = new IntuneService(req.authProvider);
...
// Get device actions
router.get('/devices/:deviceId/actions', authenticateToken, validateUUID('deviceId'), asyncHandler(async (req: any, res) => {
  try {
    const { deviceId } = req.params;
    const intuneService = new IntuneService(req.authProvider);
